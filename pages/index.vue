...
<template>
  <article class="about active" data-page="about">
    ...
    <section class="about-text">
      <ul class="about-list">
        <!-- <h3>
          I am a highly motivated and ambitious final year Computer Science student, passionate about leveraging technology to drive innovation and solve real-world problems. With a solid foundation in computer science principles and a keen eye for detail, I am dedicated to delivering exceptional results in every project I undertake.
        </h3> -->
    ...
    <div class="modal-container" :class="{ active: activeModal }">
      ...
      <section class="testimonials-modal">
        ...
        <div class="flex gap-5 items-start">
          <img class="my-auto hidden md:block" src="" alt="quote icon">
    ...
    <section class="clients">
      ...
      <ul class="clients-list has-scrollbar">
        <li class="clients-item">
          <a href="https://mql5.com" target="_blank">
            <img src="./../assets/images/mql5.png" alt="Company">
          </a>
        </li>

         <li class="clients-item">
            <a href="https://custombuyz.com" target="_blank">
              <img src="./../assets/images/custombuy.png" alt="Company">
            </a>
          </li>
